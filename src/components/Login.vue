<template>
    <div class="login-form">
        ...
        <div class="form-group">
            ...
            <input :class="['input-group', isEmailValid()]" type="email" class="form-control form-control-lg" v-model="email" />
        </div>
        <div class="form-group">
            <label>Password</label>
            <input ref="inputPassowrd" type="password" class="form-control form-control-lg" v-model="password" />
